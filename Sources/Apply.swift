...
public struct Apply {
    ...
    /**
     ...
     - parameters:
         ...
         - block: The block that is to be passed to be run on a .
     */
    public static func userInteractiveSync(_ iterations: Int, block: @escaping (Int) -> Void) {
        GCD.userInteractive.queue.sync {
            DispatchQueue.concurrentPerform(iterations: iterations, execute: block)
        }
    }
    ...
    /**
     ...
     - parameters:
         ...
         - block: The block that is to be passed to be run on a .
     */
    public static func userInitiatedSync(_ iterations: Int, block: @escaping (Int) -> Void) {
        GCD.userInitiated.queue.sync {
            DispatchQueue.concurrentPerform(iterations: iterations, execute: block)
        }
    }
    ...
    /**
     ...
     - parameters:
         ...
         - block: The block that is to be passed to be run on a .
     */
    public static func utilitySync(_ iterations: Int, block: @escaping (Int) -> Void) {
        GCD.utility.queue.sync {
            DispatchQueue.concurrentPerform(iterations: iterations, execute: block)
        }
    }
    ...
    /**
     ...
     - parameters:
         ...
         - block: The block that is to be passed to be run on a .
     */
    public static func backgroundSync(_ iterations: Int, block: @escaping (Int) -> Void) {
        GCD.background.queue.sync {
            DispatchQueue.concurrentPerform(iterations: iterations, execute: block)
        }
    }
    ...
    /**
     ...
     - parameters:
         ...
         - block: The block that is to be passed to be run on a .
     */
    public static func customSync(queue: DispatchQueue, iterations: Int, block: @escaping (Int) -> Void) {
        queue.sync {
            DispatchQueue.concurrentPerform(iterations: iterations, execute: block)
        }
    }
